...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if the PersonSSN exists in the VehicleRegRequestor table
    $checkQuery = "SELECT * FROM VehicleRegRequestor WHERE PersonSSN = '$PersonSSNToDelete'";
    $checkResult = $mysqli->query($checkQuery);

    // If PersonSSN is found, delete the records
    if ($checkResult->num_rows > 0) {
        $deleteQuery = "DELETE FROM VehicleRegRequestor WHERE PersonSSN = '$PersonSSNToDelete'";
        ...
        echo "Error: PersonSSN '$PersonSSNToDelete' not found in VehicleRegRequestor table. Please enter a valid PersonSSN.";
    }
}
...
<head>
    ...
    <title>Delete Vehicle Registration Requestor Data</title>
</head>
<body>

    <h2>Delete Vehicle Registration Requestor Data</h2>
