...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if the PersonSSN exists in the CurrentDriver table
    $checkQuery = "SELECT * FROM CurrentDriver WHERE PersonSSN = '$PersonSSNToDelete'";
    $checkResult = $mysqli->query($checkQuery);

    // If PersonSSN is found, delete the records
    if ($checkResult->num_rows > 0) {
        $deleteQuery = "DELETE FROM CurrentDriver WHERE PersonSSN = '$PersonSSNToDelete'";
        ...
        echo "Error: PersonSSN '$PersonSSNToDelete' not found in CurrentDriver table. Please enter a valid PersonSSN.";
    }
}
...
<head>
    ...
    <title>Delete Current Driver Data</title>
</head>
<body>

    <h2>Delete Current Driver Data</h2>
