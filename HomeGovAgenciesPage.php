...
<head>
    ...
    <title>Home Government Agencies Page (Granted by Admin)</title>
</head>
<body>

    <h1>Home Government Agencies Page (Granted by Admin)</h1>
    ...
    <a href="RegistrationPage.php">
        <button type="button">Go to User Registration Page</button>
    </a>
    <a href="LoginAdminpage.php">
        <button type="button">Go to Login Admin Page</button>
    </a>
    <a href="RegistrationAdminPage.php">
        <button type="button">Go to Registration Admin Page</button>
    </a>

    <h2>Main Entities Section</h2>
